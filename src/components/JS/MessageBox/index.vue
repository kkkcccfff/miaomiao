...
<style scoped>
.messageBox{width:200px;height: 140px;border: 1px #ccc solid;border-radius: 4px;background: white;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;top: 50%;transform: translate(-50%,-50%);}
